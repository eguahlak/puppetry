...
var _egualak$puppetry$Puppetry_ColorSelector$ColorSelection = F3(
	function (a, b, c) {
		return {color: a, active: b, state: c};
	});
var _egualak$puppetry$Puppetry_ColorSelector$Config = F3(
	function (a, b, c) {
		return {x: a, y: b, onChange: c};
	});
...
var _egualak$puppetry$Puppetry_ColorSelector$init = function (c) {
	return {color: c, active: false, state: _egualak$puppetry$Puppetry_ColorSelector$Passive};
};
					...
					_0: {
						...
						_0: A2(
							_elm_lang$svg$Svg$circle,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill('#eeeeee'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _egualak$puppetry$Puppetry_Lamp$lampColor = F2(
	function (cs, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{selector: cs});
...
var _egualak$puppetry$Puppetry_Lamp$lamp = F2(
	function (r, l) {
		return {
			selector: _egualak$puppetry$Puppetry_ColorSelector$init(_elm_lang$core$Color$black),
			rackIndex: r,
			lampIndex: l
		};
	});
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill(
										_egualak$puppetry$Puppetry_Utilities$colorToCss(model.selector.color)),
									_1: {
										ctor: '::',
										_0: _mpizenberg$elm_touch_events$SingleTouch$onEnd(
...
var _egualak$puppetry$Puppetry_Lamp$Model = F3(
	function (a, b, c) {
		return {selector: a, rackIndex: b, lampIndex: c};
	});
var _egualak$puppetry$Puppetry_Lamp$Config = F3(
	function (a, b, c) {
		return {x: a, y: b, onClick: c};
	});

var _egualak$puppetry$Main$wsUrl = 'ws://localhost:3000';
		...
		switch (_p0.ctor) {
			...
			case 'Send':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$websocket$WebSocket$send, _egualak$puppetry$Main$wsUrl, 'poke'),
						_1: {ctor: '[]'}
					});
			case 'LeftChanged':
				var _p1 = _p0._0;
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							lamps: A3(
								...
								model.selectedLamp.lampIndex,
								A2(_egualak$puppetry$Puppetry_Lamp$lampColor, _p1, model.selectedLamp),
								model.lamps),
							text: _egualak$puppetry$Puppetry_ColorSelector$toText(_p1.state)
						}),
					{ctor: '[]'});
			case 'RightChanged':
				var _p2 = _p0._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							right: _p2,
							text: _egualak$puppetry$Puppetry_ColorSelector$toText(_p2.state)
						}),
					{ctor: '[]'});
			case 'LampClicked':
				var _p3 = _p0._0;
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							text: A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p3.lampIndex),
									' clicked'))
						}),
					{ctor: '[]'});
			default:
...
var _egualak$puppetry$Main$init = function () {
	var sLamp = A2(_egualak$puppetry$Puppetry_Lamp$lamp, 0, 1);
	return {
		ctor: '_Tuple2',
		_0: {
			left: _egualak$puppetry$Puppetry_ColorSelector$init(
				A3(_elm_lang$core$Color$rgb, 255, 255, 0)),
			right: _egualak$puppetry$Puppetry_ColorSelector$init(
				A3(_elm_lang$core$Color$rgb, 255, 0, 255)),
			lamps: _elm_lang$core$Array$fromList(
				{
					ctor: '::',
					_0: A2(_egualak$puppetry$Puppetry_Lamp$lamp, 0, 0),
					_1: {
						ctor: '::',
						_0: sLamp,
						_1: {
							ctor: '::',
							_0: A2(_egualak$puppetry$Puppetry_Lamp$lamp, 0, 2),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _egualak$puppetry$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {left: a, right: b, lamps: c, selectedLamp: d, text: e, number: f};
	});
var _egualak$puppetry$Main$Dummy = {ctor: 'Dummy'};
var _egualak$puppetry$Main$LampClicked = function (a) {
	return {ctor: 'LampClicked', _0: a};
};
var _egualak$puppetry$Main$lampView = F2(
	function (model, index) {
		var lx = 100 + (400 * index);
		var _p4 = A2(_elm_lang$core$Array$get, index, model.lamps);
		if (_p4.ctor === 'Just') {
			return A2(
				_egualak$puppetry$Puppetry_Lamp$view,
				{x: lx, y: 105, onClick: _egualak$puppetry$Main$LampClicked},
				_p4._0);
		} else {
			return A2(
				_elm_lang$svg$Svg$rect,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$x(
						_elm_lang$core$Basics$toString(lx - 3)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y('102'),
						_1: {
							ctor: '::',
...
var _egualak$puppetry$Main$RightChanged = function (a) {
	return {ctor: 'RightChanged', _0: a};
};
var _egualak$puppetry$Main$LeftChanged = function (a) {
	return {ctor: 'LeftChanged', _0: a};
};
var _egualak$puppetry$Main$Send = {ctor: 'Send'};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$fill('#0000ff'),
											_1: {ctor: '[]'}
										}
									}
								}
					...
					_1: {
						ctor: '::',
						_0: A2(_egualak$puppetry$Main$lampView, model, 0),
						_1: {
							ctor: '::',
							_0: A2(_egualak$puppetry$Main$lampView, model, 1),
							_1: {
								ctor: '::',
								_0: A2(_egualak$puppetry$Main$lampView, model, 2),
								_1: {
									ctor: '::',
									_0: A2(
										_egualak$puppetry$Puppetry_ColorSelector$view,
										{x: 200, y: 300, onChange: _egualak$puppetry$Main$LeftChanged},
										model.left),
									_1: {
										ctor: '::',
										_0: A2(
											_egualak$puppetry$Puppetry_ColorSelector$view,
											{x: 800, y: 300, onChange: _egualak$puppetry$Main$RightChanged},
											model.right),
										_1: {ctor: '[]'}
									}
								}
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_egualak$puppetry$Main$Send),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _egualak$puppetry$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _egualak$puppetry$Main$wsUrl, _egualak$puppetry$Main$Receive);
};
var _egualak$puppetry$Main$main = _elm_lang$html$Html$program(
